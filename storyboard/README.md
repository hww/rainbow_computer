...
После регисторов пиксел и цвета следует мультиплексор и одна из двух опций палитры.

![ОЗУ пикселов 1](../images/dram_pixels_3.png)

Цвет бордюра поступает от прграммируемого прралельного порта PPI 1.

![ОЗУ пикселов 1](../images/dram_pixels_4.png)
