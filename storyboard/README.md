...
Небольшое дополнение. Подключение выводов PPI1 и PPI2 к системному разьему не дает полной информации об их использовании внутри платы. Дальнейшее исследование может показать что некоторые из этих выводов имеют какуюлибо функцию внутри платы, почему нет? 
