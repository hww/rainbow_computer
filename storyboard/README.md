...
На этой плате он собран на 140УД6. Схема напоминает ту что в СПЕЦИАЛИСТе, но есть и отличия. Однако опять, элементов в плате недостатоно чтобы повторить этот вариант. Я буду использовать вариант из СПЕЦАЛИСТа. Возможно что
