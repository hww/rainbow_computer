...
Помню в первых версиях плат был "шелест" и потрескивание в звуке при переходе громкости от одной к другой. Связано было с перезарядкой элеткролитической ёмкости в тракте. Затем проблему удалось устранить. Не помню каким образом. 
Схемотехниа такова, что в случае программирования таймера на выдачу константной величины 1, позволял возспроизводить звук изменением лишь громкости. Это было сделано умышлено, заимсвовано в PSG у MSX.
